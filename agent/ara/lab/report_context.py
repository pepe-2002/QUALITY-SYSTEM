...
def render() -> str:
    ...
    return "\n".join([
        ...
        "",
        "## 5. La correction tentée, et rejetée",
        "",
        ...
        "",
        "Toute amélioration de ce mécanisme devient **CONTEXT-V3**, évaluée sur",
        "un **jeu 8** indépendant, écrit avant son exécution. CONTEXT-V2 est",
        "figée telle que mesurée ; le jeu 7 ne sert plus à juger, il ne sert plus",
        "qu'à constater une régression.",
        "",
        "## 7. Limites restantes",
        "",
